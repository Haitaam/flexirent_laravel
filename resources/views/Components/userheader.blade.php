...
</ul><a class="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-100 text-sm text-gray-900 font-bold  rounded-xl transition duration-200" href="{{ route('utilisateurs.create') }}">Modifier votre profile</a>
<a class="hidden lg:inline-block py-2 px-6 bg-black hover:bg-slate-700 text-sm text-white font-bold rounded-xl transition duration-200" href="{{ route('logout') }}">Deconnexion</a>
</nav>
